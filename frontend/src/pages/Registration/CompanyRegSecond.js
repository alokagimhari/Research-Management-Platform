...
export const RegCompanySecondPage = (props) => {
                    ...
                    <div className='mb-5' style={{ marginLeft: '0%', marginRight: '0%', marginTop: '5%' }}>
                        <div className='border-left border-top border-success shadow rounded-3 bg-light'>
                            <form className='px-1 mx-3 mt-5 mb-5'>
                                <h2 className='text-center mb-4 font-form-head-2'>Company Details</h2>
                                <div class="form-group">
                                    <h6 className="form-font">Company Address</h6>
                                ...
                                <div align="center">
                                    <button type="submit" class="btn btn-primary mt-2 mb-4 form-signin-button button-gap"><a className='button-anchor' href='/reg-company-firstpage'>Previous Page</a></button>
                                    <button type="submit" class="btn btn-primary mt-2 mb-4 form-signin-button button-gap"><a className='button-anchor' href='/reg-company-submitpage'>Next Page</a></button>
                                </div>
                            </form>
                        </div>
                    </div>
